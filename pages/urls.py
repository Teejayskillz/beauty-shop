...
from .views import home_view, agreement_view, agreements_view, contract_agreement_view, contract_agreement_view_2, contract_success_view, contract_list_view, contract_detail_view, contract_logout_view
...
urlpatterns = [
    ...
    path('contract2/', contract_agreement_view_2, name='contract_agreement_2'),
